...
<head>
    ...
    <title>Fundación Educativa Carlo Magno | Misión</title>
...
<body>
    ...
    <div class="btn-flotante">
        <a href="https://api.whatsapp.com/send?phone=573168476702" rel="nofollow"  target="_blank"><img loading="lazy" src="build/img/icons-whatsapp-96.png" alt="whatsapp"></a>
    </div>
    ...
    <main class="contenido-principal contenedor">
        <div class="contenido-historia">
            ...
            <div class="bloque-historia">
                <h2 class="texto-bienvenida">Misión <span>Fundación Carlo Magno</span></h2>
                <img loading="lazy" class="title-lineal" src="build/img/title-02.png" alt="">
                <div class="bloque-texto">
                    <p>Promover programas de inclusión en las áreas de formación deportiva, ecológica, educativa, complementación, actualización o supletorios de duración variable, educar personas para que cumplan con las exigencias laborales y mejorar la calidad de vida de jóvenes y adultos que se encuentran en las distintas comunidades, veredas, corregimientos, municipios y ciudades del territorio Nacional.</p>
                </div> 
            </div>
        </div>
