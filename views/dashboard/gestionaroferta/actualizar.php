...
<main class="actualizar-oferta style-main">
    <h3>Actualizar</h3>
    <div class="btn">
    ...
    <div class="form-oferta">
        ...
        <form class="formulario" method="POST" enctype="multipart/form-data">
            <div class="estado">
                ...
                <label id="estado" for="cedula">Si</label>
                <input id="cedula" type="radio" name="estado" value="1" <?php echo $oferta->estado=='1'?'checked':''; ?> required>
                <label id="estado" for="nombre">No</label>
                <input id="nombre" type="radio" name="estado" value="0" <?php echo $oferta->estado=='0'?'checked':''; ?> required>
            </div>
            ...
            <div class="formulario-campo">
                ...
                <textarea class="<?php echo isset($resaltarerror['descripcion'])?'marcarerror':''; ?>" name="descripcion" cols="30" rows="4"><?php echo $oferta->descripcion ?? ''; ?></textarea>
