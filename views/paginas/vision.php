...
<body>
    ...
    <div class="btn-flotante">
        <a href="https://api.whatsapp.com/send?phone=57<?php echo $info->whatsapp; ?>" rel="nofollow" target="_blank"><img src="build/img/icons-whatsapp-96.png" alt="whatsapp"></a>
    </div>
    ...
    <main class="contenido-principal contenedor">
        <div class="contenido-historia">
            ...
            <div class="bloque-historia">
                <h2 class="texto-bienvenida">Visión <span>Fundacion Educativa Artistica y Cultural CarloMagno</span></h2>
                <img class="title-lineal" src="build/img/title-02.png" alt="">
                <div class="bloque-texto">
                    <p><?php echo $infonosotros->vision ?? ''; ?></p>
                </div> 
            </div>
        </div>
