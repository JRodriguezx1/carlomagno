...
<body>
    ...
    <div class="btn-flotante">
        <a href="https://api.whatsapp.com/send?phone=<?php echo '57'.$info->nit; ?>" rel="nofollow"  target="_blank"><img loading="lazy" src="build/img/icons-whatsapp-96.png" alt="whatsapp"></a>
    </div>
    ...
    <main class="contenido-principal contenedor">
        <div class="contenido-historia">
            ...
            <div class="bloque-historia">
                <h2 class="texto-bienvenida">Misión <span>Fundacion Educativa Artistica y Cultural CarloMagno</span></h2>
                <img loading="lazy" class="title-lineal" src="build/img/title-02.png" alt="">
                <div class="bloque-texto">
                    <p><?php echo $infonosotros->mision ?? ''; ?></p>
                </div> 
            </div>
        </div>
