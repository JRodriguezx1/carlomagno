...
<head>
    ...
    <title>Fundación Educativa Carlo Magno | Objetivos</title>
    ...
    <main class="contenido-principal contenedor">
        <div class="contenido-historia">
            ...
            <div class="bloque-historia">
                <h2 class="texto-bienvenida">Objetivos <span>Fundacion Educativa Artistica y Cultural CarloMagno</span></h2>
                <img loading="lazy" class="title-lineal" src="build/img/title-02.png" alt="">
                <div class="bloque-texto">
                    <p> <?php echo $infonosotros->objetivos ?? ''; ?> </p>
                </div> 
            </div>
        </div>
